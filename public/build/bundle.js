...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainView = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactCodemirror = __webpack_require__(162);
	  ...
	  _createClass(MainView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactCodemirror2.default, { value: this.state.code, onChange: this.updateCode.bind(this), options: options })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var className = __webpack_require__(163);
	...
	var CodeMirror = React.createClass({
		...
		getCodeMirrorInstance: function getCodeMirrorInstance() {
			return this.props.codeMirrorInstance || __webpack_require__(166);
		},
		...
		render: function render() {
			...
			return React.createElement('div', { className: editorClassName }, React.createElement('textarea', { ref: 'textarea', name: this.props.path, defaultValue: this.props.value, autoComplete: 'off' }));
		}
	});
